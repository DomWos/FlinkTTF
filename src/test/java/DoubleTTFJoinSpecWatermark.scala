...
class DoubleTTFJoinSpecWatermark extends TestUtils with GivenWhenThen with Eventually {
  ...
  "Demo" should
    """
     show that the properly watermarked streams will not cause bad results if late""".stripMargin in {
