...
class DoubleTTFJoinSpecWatermarkIssueFail extends TestUtils with GivenWhenThen with Eventually {
  ...
  "Demo" should
    """
      show that TTF join is subject to watermarking issue (FAILED)
    """.stripMargin in {
