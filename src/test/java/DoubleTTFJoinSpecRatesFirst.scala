...
class DoubleTTFJoinSpecRatesFirst extends TestUtils with GivenWhenThen with Eventually {
  ...
  "Demo" should
    """
     show that joins are properly done if rates arrive first""".stripMargin in {
