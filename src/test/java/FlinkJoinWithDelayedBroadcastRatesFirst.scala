...
class FlinkJoinWithDelayedBroadcastRatesFirst extends TestUtils with Eventually {
  ...
  "Demo" should
   ...
   //Watermark will be emitted hermark will be emitted here but it will be min from all streams(18000L, Long.MAX, Long.MIN)
    val expectedResults = Seq(
      new AllJoined(taxi2.getTs, taxi2.getPrice * usd4.getRate, new Utf8(usd1.getRatesCcyIsoCode.toString), usd4.getTs, usd4.getRate, new Utf8(usd1.getRatesCcyIsoCode.toString), new Utf8(usdCcyIsoDTO.getCcyIsoName.toString), usd4.getRate, usd4.getTs),
      new AllJoined(taxi3.getTs, taxi3.getPrice * usd4.getRate, new Utf8(usd1.getRatesCcyIsoCode.toString), usd4.getTs, usd4.getRate, new Utf8(usd1.getRatesCcyIsoCode.toString), new Utf8(usdCcyIsoDTO.getCcyIsoName.toString), usd4.getRate, usd4.getTs),
      new AllJoined(taxi4.getTs, taxi4.getPrice * usd4.getRate, new Utf8(usd1.getRatesCcyIsoCode.toString), usd4.getTs, usd4.getRate, new Utf8(usd1.getRatesCcyIsoCode.toString), new Utf8(usdCcyIsoDTO.getCcyIsoName.toString), usd4.getRate, usd4.getTs),
      new AllJoined(taxi5.getTs, taxi5.getPrice * usd4.getRate, new Utf8(usd2.getRatesCcyIsoCode.toString), usd4.getTs, usd4.getRate, new Utf8(usd2.getRatesCcyIsoCode.toString), new Utf8(usdCcyIsoDTO.getCcyIsoName.toString), usd4.getRate, usd4.getTs),
      new AllJoined(taxi6.getTs, taxi6.getPrice * usd4.getRate, new Utf8(usd2.getRatesCcyIsoCode.toString), usd4.getTs, usd4.getRate, new Utf8(usd2.getRatesCcyIsoCode.toString), new Utf8(usdCcyIsoDTO.getCcyIsoName.toString), usd4.getRate, usd4.getTs),
      new AllJoined(taxi7.getTs, taxi7.getPrice * usd4.getRate, new Utf8(usd3.getRatesCcyIsoCode.toString), usd4.getTs, usd4.getRate, new Utf8(usd3.getRatesCcyIsoCode.toString), new Utf8(usdCcyIsoDTO.getCcyIsoName.toString), usd4.getRate, usd4.getTs),
      new AllJoined(taxi8.getTs, taxi8.getPrice * usd4.getRate, new Utf8(usd3.getRatesCcyIsoCode.toString), usd4.getTs, usd4.getRate, new Utf8(usd3.getRatesCcyIsoCode.toString), new Utf8(usdCcyIsoDTO.getCcyIsoName.toString), usd4.getRate, usd4.getTs)
    )
